...
dailymodelexpose[0, :, :]=0.025*dailygridcases[0, :, :] # 23 from 9-8 to 11-25  
...
dailymodelcases[0, :, :]=1.01*dailygridcases[0, :, :] # 78 from 9-8 to 11-25 
summodelcases[0, :, :]=1.01*dailygridcases[0, :, :] # 78 from 9-8 to 11-25
print(dailygridcases[0, 14, 9]) 
