...
citycasesbook = xlrd.open_workbook('/mnt/4E0AC9410AC926B5/Linux/COVID/German/German_Data.xlsx')
...
dailygridcases=np.zeros([studynumdays, 25, 25])
...
for idx in range(citynum):
    ...
    dailycitycases=citycasesgrid[0, 54+idxcityid*totaldays:84+idxcityid*totaldays]#still strings
...
ep=0.095 #0.095/8 #0.08 
l1=0.293 #0.293/8 #0.293
p13=0.129 #0.129/8 #0.129
pcd=0.628 #0.628/8 #0.628
...
dailymodelexpose[0, :, :]=0.5*dailygridcases[10, :, :]
...
dailymodelexpose[0, :, :]=dailymodelexpose[0, :, :] #24*dailymodelexpose[0, :, :] # 24 from 2-25 to 3-14

dailymodelcases[0, :, :]=dailygridcases[0, :, :] #dailygridcases[0+20, :, :] # 20 from 2-25 to 3-14

summodelcases[0, :, :]=dailygridcases[0, :, :] #dailygridcases[0+20, :, :] # 20 from 2-25 to 3-14
...
trainfile = open('COVIDMAPS_kai_softlock_03.dat','w')
